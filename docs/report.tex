...
% TODO pictures of the preprocessing
...
\caption{The gold images created as a mean of all examples of each symbol. In order we have symbols reprenting buildings, dirt, forest, grass, rocks, and water.}
